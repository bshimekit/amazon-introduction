    ...
    return (
      ...
      <section className={classes.login}>
        ...
        <div className={classes.login__container}>
          ...
          {/*create acct btn*/}
          <button type='submit' name='signup' onClick={authHandler} className={classes.login__registerButton}>{loading.signUp?(<ClipLoader color='#000' size={15}></ClipLoader>):("Create your Amazon Account") }</button>
